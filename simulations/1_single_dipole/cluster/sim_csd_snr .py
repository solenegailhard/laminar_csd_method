...
- coergister to multilayer surface and invert using EBB to extract source time series in each layer
...
if __name__ == '__main__':
    ...
    output_sim_fname = f"vx{vertex_sim_idx}_snr{snr_sim_idx}"
