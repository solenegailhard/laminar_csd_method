...
# ----- #
# Job name
#SBATCH --job-name=2_simult_sources
...
python -u /pbs/home/s/sgailhard/csd_simulations/sim_csd_2_simult_sources_snr.py > /sps/isc/sgailhard/csd_simulations/output/output_2_simult_sources_snr_$SLURM_ARRAY_TASK_ID.txt 2> /sps/isc/sgailhard/csd_simulations/output/error_2_simult_sources_snr_$SLURM_ARRAY_TASK_ID.txt ${SLURM_ARRAY_TASK_ID}